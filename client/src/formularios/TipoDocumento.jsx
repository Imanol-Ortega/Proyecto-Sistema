...
function TipoDocumento() {
    ...
    const cargarTipoDocumento = async(id)=>{
      try {
        const resp = await getTipoDocumentoRequest(id);
        setTipoDocumento({
    ...
    <div>
        <Formik
          ...
          onSubmit={async(values,actions)=>{
            ...
            if(params.id){
                await updTipoDocumentosRequest(params.id,values);
            }else{
                await postTipoDocumentosRequest(values);
            }
