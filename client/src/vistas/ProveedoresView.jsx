                                                                    ...
                                                                    <tr key={proveedor.proveedorid}>
                                                                        ...
                                                                        <td className="p-2 whitespace-nowrap">
                                                                            <div className="text-right">
                                                                                <Link to={`/proveedores/edit/${proveedor.proveedorid}`} className='px-3 py-1 text-white font-light tracking-wider bg-blue-600 hover:bg-blue-500 rounded text-xs -ml-10 mr-2'>Editar</Link>
